...
public class LoginView extends JFrame {
	...
	public LoginView() {
		...
		//setting the condition for the different events to happen
				...
				if(  username.contains("use") && password.contains("1234")) {
                                    //adding an action to wipe the fields once submitted
					text1.setText(null);
					text2.setText(null);
                                     //setting the message to be displayed in case of valid input
					JOptionPane.showMessageDialog(null, "User logged in successfully","Login message",JOptionPane.INFORMATION_MESSAGE);
		...
		JButton button3=new JButton("Click here if you don't have an account");
